...
export const OperationsProtocolSchemas = {
  ...
  FoldersTreeRefreshParams: folderRules.FoldersTreeRefreshParamsSchema,
  FoldersTreeRefreshResult: folderRules.FoldersTreeRefreshResultSchema,
  ...
  FolderOrphanRule: folderRules.FolderOrphanRuleSchema,
  FoldersRulesOrphansParams: folderRules.FoldersRulesOrphansParamsSchema,
  FoldersRulesOrphansResult: folderRules.FoldersRulesOrphansResultSchema,
  FoldersRulesOrphansClearParams: folderRules.FoldersRulesOrphansClearParamsSchema,
  FoldersRulesOrphansClearResult: folderRules.FoldersRulesOrphansClearResultSchema,
