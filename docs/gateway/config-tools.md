...
| Profile     | Includes                                                                                                                                                                                                                                                |
| ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `readonly`  | `read`, `web_search`, `web_fetch`, `memory_search`, `memory_get`, `view_image`, `media_list`, `media_read`, `session_status`                                                                                                                                                        |
...
| `messaging` | `group:messaging`, `sessions`, `sessions_list`, `sessions_history`, `sessions_search`, `conversations_list`, `conversations_send`, `conversations_turn`, `sessions_send`, `sessions_spawn`, `sessions_yield`, `subagents`, `session_status`, `ask_user`, `media_list`, `media_read` |
...
| `group:media`      | `image`, `media_list`, `media_read`, `image_generate`, `music_generate`, `video_generate`, `tts`                                                                                                                                                                                     |
