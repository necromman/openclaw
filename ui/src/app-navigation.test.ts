...
describe("subtitleForRoute", () => {
  it("returns expected subtitles for every route", () => {
    expect(
      ...
      lobsterdex: "Every mascot palette that has visited this browser.",
      ...
      "model-catalog": "Which model answers, and which models people can pick in chat.",
