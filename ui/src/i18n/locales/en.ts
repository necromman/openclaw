...
export const en: TranslationMap & {
  ...
  skillsPage: {
    ...
    search{brandSkillHub}: "Search {brandSkillHub} skills…",
    searching: "Searching…",
    disconnected: "Not connected to gateway.",
    empty: "No skills found.",
    no{brandSkillHub}Results: "No skills found on {brandSkillHub}.",
    notScannedBy{brandSkillHub}: "Not scanned by {brandSkillHub}",
    install: "Install",
    installed: "Installed",
  ...
  pluginsPage: {
    ...
    browse{brandSkillHub}: "Browse {brandSkillHub}",
    refresh: "Refresh",
    ...
    from{brandSkillHub}: "From {brandSkillHub}",
    no{brandSkillHub}ResultsBody: "{brandSkillHub} has no results for “{query}”.",
    ...
    connector{brandSkillHub}Note: "Community plugins on {brandSkillHub}",
    connectorAdd: "Add",
  ...
  appsPage: {
    ...
    ctaBrowse{brandSkillHub}: "Browse {brandSkillHub}",
