...
export const en: TranslationMap & {
  ...
  lazyView: {
    ...
    staleSubtitle: "{brand} was updated in the background. Reload to get the latest panel.",
    reloading: "Reloading…",
    retry: "Retry",
    stylesFailed: "Styles failed to load, so the page may look broken.",
  },
  communityInvite: {
    cardLabel: "Join the {brand} community on Discord",
    artAlt: "Community artwork",
  ...
  updates: {
    ...
    triage: {
      hostHint:
        "If Ask {brand} is unavailable, run `openclaw triage` on the Gateway host to open a local coding agent for diagnosis and repair. Diagnose the cause before retrying.",
    },
    failureReasons: {
      ...
      notOpenclawRoot:
        "Run the update from an {brand} checkout or use the CLI global reinstall path.",
  ...
  devices: {
    ...
    pairing: {
      ...
      qrAlt: "{brand} mobile pairing QR code",
      ...
      review: "Review",
      waiting: "Official {brand} mobile apps connect automatically after scanning.",
  ...
  worktrees: {
    ...
    subtitle: "Isolated repository checkouts owned by {brand}.",
  ...
  newSession: {
    ...
    nativeTerminalHint:
      "Start the native CLI on the selected machine using its own account and configuration. This does not create an {brand} Chat.",
  ...
  sessionsView: {
    ...
    deletePreservedReasons: {
      ...
      "snapshot-failed": "{brand} could not create a safety snapshot",
    ...
    moveSessionNoReplayWarning:
      "{brand} safely reconciles the current workspace before moving. Active work is never replayed.",
  ...
  quickSettings: {
    ...
    appearance: {
      ...
      lobsterdexOpen: "Open mascot gallery",
    },
    security: {
  ...
  approvalPage: {
    ...
    connectionErrorDescription:
      "{brand} cannot confirm or record a decision while disconnected. Reconnect to check the current status.",
    retry: "Retry",
  ...
  skillsPage: {
    ...
    shown: "{count} shown",
    clawHub: "{brandSkillHub}",
    clawHubSubtitle: "Search and install skills from the registry",
    searchClawHub: "Search {brandSkillHub} skills…",
    searching: "Searching…",
    disconnected: "Not connected to gateway.",
    empty: "No skills found.",
    noClawHubResults: "No skills found on {brandSkillHub}.",
    notScannedByClawHub: "Not scanned by {brandSkillHub}",
    install: "Install",
    installed: "Installed",
    ...
    invalidLink: "{brandSkillHub} link invalid",
    overview: "Overview",
  ...
  browser: {
    ...
    navigationCheckFailed: "{brand} couldn’t verify this tab’s address. Refresh to try again.",
    title: "Browser",
    open: "Open",
  ...
  subtitles: {
    ...
    titles: "Job titles you can grant people and name in a folder rule.",
    modelCatalog: "Which model answers, and which models people can pick in chat.",
  ...
  modelSetup: {
    ...
    intro:
      "{brand} checks the AI access available on this Gateway and verifies the exact model before it enables conversations.",
    required: {
      title: "No AI provider configured",
      body: "We couldn't find a provider and model configured for this agent. Choose a supported connection; {brand} will test it before enabling chat.",
    ...
    access: {
      ...
      gatewayTooOld: "The Gateway is running an older {brand} version",
    },
    candidates: {
    ...
    manual: {
      ...
      verifyHint: "{brand} verifies a real model reply before marking the connection ready.",
      required: "Choose a provider and enter an API key or token.",
    },
    success: {
      title: "Connection verified",
      body: "{brand} received a real reply from {modelRef}. You can start chatting now.",
  ...
  onboarding: {
    memoryImport: {
      ...
      body: "{brand} found memory from other coding assistants. Import it into your agent workspace?",
      ...
      doneBody: "Migrated {migrated}, skipped {skipped}. You can continue setting up {brand}.",
    },
  },
  assistantPanel: {
  ...
  custodian: {
    ...
    cancel: "Cancel",
    send: "Send",
    thinking: "{brand} is thinking",
    earlier: "Earlier",
    requestFailed: "{brand} could not reply. Try again.",
    connectionChanged: "The Gateway connection changed. Retry to continue this setup.",
    sessionRestarted:
      "{error} {brand} started a fresh session; earlier messages remain for context.",
    unsupportedGateway: "Update the Gateway to continue setup with {brand}.",
    panel: {
      title: "{brand}",
      toggle: "Toggle Ask {brand}",
      close: "Close Ask {brand}",
      resize: "Resize Ask {brand}",
      dockBottom: "Dock Ask {brand} at bottom",
      dockRight: "Dock Ask {brand} at right",
    },
    history: {
      button: "History",
      ...
      requestFailed: "{brand} could not load change history.",
      loadMore: "Load more",
    ...
    nudge: {
      ...
      channelSetupTitle: "Reach {brand} outside this app",
      channelSetupBody:
        "The web app already works. Add a channel only if you want to message {brand} from another service.",
  ...
  mcpPage: {
    intro: "Connect and manage MCP servers that provide tools to {brand}.",
    servers: "Servers",
    oauth: "OAuth",
    filtered: "Filtered",
  ...
  memoryPage: {
    intro: "Choose how {brand} stores, searches, and maintains agent memory.",
  ...
  pluginsPage: {
    ...
    searchPlaceholder: "Search plugins and {brandSkillHub}",
    browseClawHub: "Browse {brandSkillHub}",
    refresh: "Refresh",
    ...
    searching: "Searching {brandSkillHub}…",
    searchResultCountOne: "{count} result",
    searchResultCount: "{count} results",
    fromClawHub: "From {brandSkillHub}",
    noClawHubResultsBody: "{brandSkillHub} has no results for “{query}”.",
    ...
    connectorsHint:
      "One-click MCP connectors and hand-picked {brandSkillHub} searches for popular services.",
    ...
    connectorClawHubNote: "Community plugins on {brandSkillHub}",
    connectorAdd: "Add",
    connectorSearch: "Find on {brandSkillHub}",
    ...
    noInstalledBody: "Discover a featured plugin or search {brandSkillHub} to extend {brand}.",
    ...
    optionalCapability: "Optional {brand} capability.",
    enabled: "Enabled",
    disabled: "Disabled",
    available: "Available",
  ...
  appsPage: {
    heroTitle: "Take {brand} everywhere",
    heroTagline:
    ...
    ctaBrowseClawHub: "Browse {brandSkillHub}",
    linkDiscord: "Discord community",
    linkDocs: "Docs",
    cards: {
      ios: {
        title: "iPhone",
        desc: "Chat, talk, approve actions, and share into {brand} from iOS.",
      },
      android: {
        title: "Android",
        desc: "Your Android phone as a full {brand} device — chat, camera, and Canvas.",
      },
      appleWatch: {
        title: "Apple Watch",
      ...
      wearOs: {
        title: "Wear OS",
        desc: "The Android companion extends {brand} to your watch.",
      },
      macos: {
        title: "macOS",
      ...
      windows: {
        title: "Windows",
        desc: "The Windows companion connects your PC as an {brand} device.",
      },
      linux: {
        title: "Linux",
      ...
      chrome: {
        ...
        desc: "Let {brand} drive your existing Chrome — tabs, pages, and forms.",
      },
      plugins: {
        title: "Plugins & {brandSkillHub}",
        desc: "Extend {brand} with channels, tools, and skills from the community.",
      },
    },
  },
  presence: {
  ...
  skillWorkshop: {
    ...
    selfLearning: {
      ...
      pitchBody:
        "{brand} reviews corrections and substantial completed runs, then applies scanner-approved skills and shows them on this board. Experience review spends extra background tokens.",
  ...
  chat: {
    ...
    catalogOpenTargetViewer: "{brand} viewer",
    ...
    workspaceConflict: {
      ...
      description:
        "{brand} kept your local versions and applied the other cloud changes. Inspect the staged result or take its version for a conflicted path.",
      ...
      commandsUnavailable:
        "This filename contains terminal control characters, so {brand} will not build a copyable shell command for it. Inspect the staged ref directly and enter the path manually with care.",
  ...
  cron: {
    ...
    list: {
      ...
      emptyHint: "Describe what {brand} should do and when — it runs on schedule.",
    ...
    detail: {
      ...
      newSubtitle: "Describe what {brand} should do, then pick when it runs.",
    ...
    form: {
      ...
      promptPlaceholder: "Describe what {brand} should do...",
      repeat: "Repeat",
