...
const enIxAuth = {
  ixAuth: {
    ...
    departments: {
      ...
      membersLoadFailed: "Members could not be loaded. Try again.",
      browseLoadFailed: "Folders could not be loaded. Try again.",
      retry: "Retry",
      memberRemove: "Remove",
    ...
    folders: {
      ...
      modeFolderFirst: "By folder",
      modeSubjectFirst: "By subject",
      modeSwitch: "Choose how to edit folder permissions",
      bySubjectTitle: "Folder access by subject",
      bySubjectDescription:
        "Pick a department, a role, or a person, then set every folder they may reach.",
      bySubjectPick: "Pick who this is about",
      bySubjectPickHint:
        "Nothing is loaded until a subject is chosen, because the folder list is read for that subject alone.",
      bySubjectEmpty: "Choose a department, a role, or a person to see their folders.",
      bySubjectFolders: "Folders for {name}",
      bySubjectLegend:
        "Each row shows what this subject gets today. Change a row to write a rule on that folder, and remove the rule to fall back to whatever a parent folder grants.",
      bySubjectSuperadmin:
        "The system administrator reaches every folder. Rules written here change nothing for this role.",
      rowInherited: "Inherited from a parent folder: {path}",
      rowDefault: "No rule applies, so this folder is hidden.",
      rowOwn: "Set on this folder.",
      rowError: "Refused: {message}",
      rowChanged: "Changed",
      rowRemove: "Remove rule",
      rowBelow: "Also below",
      dirtyCount: "{count} folders changed.",
      dirtySave: "Save changes",
      dirtyRevert: "Discard changes",
      saveDone: "Saved {count} folders.",
      savePartial: "Saved {count} folders. {failed} were refused.",
      switchConfirm: "Discard the unsaved folder changes?",
      switchConfirmYes: "Discard them",
      switchConfirmNo: "Keep editing",
      error: {
