...
describe("openclaw.chat", () => {
  ...
  it("returns the unchecked discovery choice through selected-agent setup detection without writing", async () => {
    ...
    await io.writeConfigFile({ agents: { entries: { main: { default: true }, research: {} } } });
