...
| `AGENTS.md` | 세션 시작 절차, 감사 7단계, 라포르몰 우선 작업 10개, 보고서 형식 |
| `COMPANY.md` | 회사·라포르몰·메디월드몰 실측 사실, 고도몰 제약, 경쟁 환경, 확인 못 한 것 (3-2) |
...
| 2 | 워크스페이스 시드 | 컨테이너의 `/home/node/.openclaw/workspace-ageo/` 에 `IDENTITY.md`·`SOUL.md`·`AGENTS.md`·`COMPANY.md` 와 `skills/` 아래 스킬 4개(`aeo-page-audit`·`aeo-crawler-access`·`aeo-schema-jsonld`·`ageo-claims-guard`)가 있고, 옛 `aeo-health-claims-guard` 폴더는 없다 |
...
| 9 | 스킬 | "이 URL 감사해 줘" 에 `AGENTS.md` 7단계 순서와 보고서 형식이 나온다 |
